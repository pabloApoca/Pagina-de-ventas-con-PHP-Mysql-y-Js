<?php 
//IncluÃ­mos inicialmente la conexiÃŗn a la base de datos
...
Class Venta
{
	...
	//Implementamos un mÃŠtodo para insertar registros
	...
	//Implementamos un mÃŠtodo para anular la venta
	...
	//Implementar un mÃŠtodo para mostrar los datos de un registro a modificar
	...
	//Implementar un mÃŠtodo para listar los registros
	...
	public function ventacabecera($idventa)
	{
		...
		p.tipo_documento,p.num_documento,p.email,p.telefono,v.idusuario,u.nombre as
		usuario,v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,
		date(v.fecha_hora) as fecha,v.impuesto,v.total_venta FROM venta v INNER JOIN
		persona p ON v.idcliente=p.idpersona INNER JOIN usuario u ON 
	...
	public function ventadetalle($idventa)
	{
		...
		d.descuento,(d.cantidad*d.precio_venta-d.descuento) as subtotal FROM
		detalle_venta d INNER JOIN articulo a ON d.idarticulo=a.idarticulo WHERE
		d.idventa='$idventa'";
		return ejecutarConsulta($sql);
	}
